...
const Refer = () => {
  ...
  return (
    <div className="bg-colorRefer bg-[#131515] min-h-screen flex flex-col items-center relative overflow-hidden">
      <ConfettiBackground />
      <div className="card gradient-box border-[1px] border-[#FFFFFF21] max-w-[400px] mt-4 rounded-[40px] p-4 text-center shadow-lg relative z-10 transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
        <div className="px-[2rem] pt-6">
          <h1 className="f-PowerGrotesk text-[40px] mx-auto xxl:text-[50px] leading-[40px] text-[#FCFCD8] max-w-[320px]">
            You are on the <br />
            <span className="bg-nexgen-gradient bg-clip-text nex-gen-text">
              waitlist!
            </span>
          </h1>
          <p className="text-[#FFF5D947] mt-8 f-HelveticaNeueLight text-[14px] leading-[19px] xxl:leading-[21px]">
        ...
        <button
          type="submit"
          className="f-PowerGrotesk bg-[#131515] text-base btn-color text-[#FFF5D9] leading-tight font-normal px-6 py-8 w-full h-[55px] mt-10 rounded-full flex items-center dark:bg-[#000000] justify-center"
        >
          Refer a friend
        </button>
      </div>
